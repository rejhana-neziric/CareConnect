import 'package:careconnect_admin/models/app_permissions.dart';
...
class PermissionProvider {
  ...
  bool canViewEmployeeScreen() {
    ...
    ]); //mozda da dodam ovdje odmah i get
  }
  ...
  bool canRescheduleAppointment() {
    return hasAllPermissions([
      AppPermissions.appointmentReschedule,
      AppPermissions.appointmentRescheduleRequested,
      AppPermissions.appointmentConfirm,
    ]);
  }
  ...
  bool canEnrollWorkshop() {
    return hasPermission(AppPermissions.workshopEnroll);
  }
  ...
  // this could be deleted because on front user does not have option to train model
  ...
  // view cleints children on client details screen
  ...
  bool canEditChild() {
    return hasPermission(AppPermissions.childUpdate);
  }
  ...
  bool canRemoveChildFromClient() {
    return hasPermission(AppPermissions.clientRemoveChildren);
  }
  ...
  bool canInsertReview() {
    return hasPermission(AppPermissions.reviewInsert);
  }
