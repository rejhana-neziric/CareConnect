...
namespace CareConnect.Services.Migrations
{
    ...
    [Migration("20250727140642_AddedCreatedAtToClientsChild")]
    partial class AddedCreatedAtToClientsChild
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareConnect.Services.Database.WorkshopType", b =>
                {
                    b.Property<int>("WorkshopTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WorkshopTypeId"));
                    ...
                    b.HasKey("WorkshopTypeId")
                        .HasName("PK__Workshop__8012C84F26FFEA45");
            ...
            modelBuilder.Entity("CareConnect.Services.Database.Payment", b =>
                {
                    b.HasOne("CareConnect.Services.Database.PaymentPurpose", "PaymentPurpose")
                        .WithMany("Payments")
                        .HasForeignKey("PaymentPurposeId")
                        .IsRequired()
                        .HasConstraintName("FK_Payments_PaymentPurposes");

                    b.HasOne("CareConnect.Services.Database.PaymentStatus", "PaymentStatus")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("CareConnect.Services.Database.Workshop", b =>
                {
                    b.HasOne("CareConnect.Services.Database.WorkshopType", "WorkshopType")
                        .WithMany("Workshops")
